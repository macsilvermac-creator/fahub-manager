...
const AdminPanel: React.FC = () => {
    ...
    const handlePersonaMatrix = (role: UserRole) => {
        ...
        if (current) {
            ...
            /* Fix: Changed logAction to logAuditAction to match storageService definition */
            storageService.logAuditAction('PERSONA_SWITCH', `Admin mudou visualização para ${role}`);

...
const MedicalLab: React.FC = () => {
    ...
    const MetricBateria = ({ label, value, color }: any) => (
        <div className="space-y-1 flex-1 min-w-[50px]">
            <div className="flex justify-between text-[6px] font-black text-text-secondary uppercase font-bold tracking-widest">
                <span>{label}</span>
            </div>
    ...
    return (
        <div className="space-y-6 animate-fade-in flex flex-col h-full pb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 shrink-0">
                <div className="bg-red-900/20 border border-red-500/20 p-4 rounded-3xl flex items-center gap-4 shadow-xl">
                ...
                <div className="bg-green-900/20 border border-green-500/20 p-4 rounded-3xl flex items-center gap-4 shadow-xl">

...
const Marketing: React.FC = () => {
    ...
    useEffect(() => {
        /* Fix: Correctly used getSocialPosts method added to storageService */
        setPosts(storageService.getSocialPosts());
        setCourses(storageService.getCourses());
        /* Fix: Correctly used getAnnouncements method added to storageService */
    ...
    const handleSavePost = () => {
        ...
        setPosts(updated);
        /* Fix: Correctly used saveSocialPostsV2 method added to storageService */
        storageService.saveSocialPostsV2(updated);
        setGeneratedContent('');
        setTopic('');
    };

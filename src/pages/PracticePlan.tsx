...
const PracticePlan: React.FC = () => {
    ...
    const handleRemoveBlock = (id: string) => {
        ...
        // Re-time calculation logic simplified for demo
                             ...
                             <div className="bg-gradient-to-r from-purple-900/40 to-indigo-900/40 p-4 rounded-xl border border-purple-500/30 mb-6 flex flex-col md:flex-row gap-4 items-center">
                                <div className="flex-1">
                                    <h4 className="font-bold text-white flex items-center gap-2 mb-1">
                                        ...
                                        Coach Copilot (IA Generativa)
                                    </h4>
                                    <p className="text-xs text-text-secondary">
                                        Descreva o foco (Ex: "Instalação de Blitz") e a IA escreverá o treino completo com aquecimento, drills e team period.
                                    </p>
                                </div>
                                <button 
                                    type="button" 
                                ...
                                >
                                    {isGeneratingScript ? <><span className="animate-spin">⚙️</span> Criando...</> : 'Gerar Roteiro com IA'}
                                </button>
                             </div>
                             ...
                             <form onSubmit={handleCreatePractice} className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="md:col-span-2">
                                        <Input label="Foco Principal (Obrigatório para IA)" value={newFocus} onChange={e => setNewFocus(e.target.value)} required placeholder="Ex: Defesa contra corrida e screens" />
                                    </div>
                                </div>
                                ...
                                <div className="bg-black/20 p-4 rounded-xl border border-white/10">
                                    ...
                                    {generatedScript.length > 0 ? (
                                        ...
                                        <div className="text-center py-8 border-2 border-dashed border-white/10 rounded-lg">
                                            <p className="text-text-secondary text-sm">Roteiro vazio. Use a IA acima ou os blocos rápidos ao lado.</p>
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="lg:col-span-1 space-y-4">
                        <div className="bg-secondary p-4 rounded-xl border border-white/5">
                            <h4 className="font-bold text-white mb-4 flex items-center gap-2">
                                <PenIcon className="w-4 h-4 text-blue-400" /> Blocos Rápidos (Manual)
                            </h4>

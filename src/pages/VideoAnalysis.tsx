...
import { ScissorsIcon, FilterIcon, PlayCircleIcon, SettingsIcon, CheckCircleIcon, TrashIcon, SparklesIcon, AlertCircleIcon, LocationIcon, PenIcon, EraserIcon, BrainIcon, EyeIcon, TrendingUpIcon, SearchIcon } from '../components/icons/UiIcons';

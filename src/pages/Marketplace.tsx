...
import { QrcodeIcon } from '../components/icons/UiIcons';
...
const Marketplace: React.FC = () => {
    ...
    const onPaymentSuccess = () => {
        if(selectedItem) {
            ...
            toast.success("Compra realizada com sucesso! Combine a entrega com o vendedor.");
        }
    };
    ...
    const handleAddItem = (e: React.FormEvent) => {
        ...
        const newItem: MarketplaceItem = {
            ...
            imageUrl: `https://plus.unsplash.com/premium_photo-1661919210043-fd847a58522d?w=400&q=80`,
            isSold: false
        };

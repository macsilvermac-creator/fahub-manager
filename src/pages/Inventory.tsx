...
const Inventory: React.FC = () => {
    ...
    useEffect(() => {
        /* Fix: Cast category and condition to literal types */
        const loadedItems = storageService.getInventory().map(i => ({
            ...i,
    ...
    const handleAssign = () => {
        ...
        const updatedItems = items.map(i => 
            ...
            ? { ...i, assignedToPlayerId: selectedPlayerId as any, quantity: i.quantity - 1 } 
            : i
        );

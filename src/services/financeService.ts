...
import { Transaction, Invoice, EventSale, TransactionCategory } from '../types';
...
export const financeService = {
    ...
    saveTransactions: (txs: Transaction[]) => {
        ...
        // Sincroniza com a nuvem se estiver online
    ...
    // Função auxiliar para criar cobranças em massa (backup para o storageService)
    createBulkInvoices: (
        playerIds: number[], 
        title: string, 
        amount: number, 

...
import { 
    ...
    AuditLog, CoordinatorTask, LeagueRanking, Objective,
...
export const storageService = {
    initializeRAM: () => {
        ...
        if (!localStorage.getItem('league_rankings')) {
            set('league_rankings', [
                ...
                { position: 2, teamName: 'Timbó Rex', record: '3-1' },
                { position: 3, teamName: 'Istepuôs', record: '2-2' }
            ]);
        }
    },
    ...
    getTeamSettings: () => getSingle<TeamSettings>('fahub_settings') || { id: '1', teamName: 'JG', logoUrl: '', primaryColor: '#059669' },
    ...
    getSponsors_alt: () => get<SponsorDeal>('fahub_sponsors'), // Internal helper

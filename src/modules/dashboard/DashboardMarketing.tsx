  ...
  return (
    <div className="h-full flex flex-col relative animate-in fade-in duration-500">
      ...
      <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 bg-[#0f172a]/40 p-6 rounded-3xl border border-white/5">
        ...
        <button className="flex items-center gap-3 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl text-xs font-black uppercase tracking-widest text-white transition-all shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 min-h-0">
        ...
        <div 
          ...
          className="bg-[#1e293b]/20 border border-emerald-500/20 hover:border-emerald-500/50 rounded-[2rem] p-8 cursor-pointer transition-all duration-500 flex flex-col justify-between backdrop-blur-sm"
        >
          ...
          <p className="text-xs text-white font-bold uppercase italic">Monitorando 02 Parceiros Ativos</p>
        </div>

        {/* SOCIAL RADAR */}
        <div 
          onClick={() => setExpandedCard('FANBASE')}
          className="bg-[#1e293b]/20 border border-pink-500/20 hover:border-pink-500/50 rounded-[2rem] p-8 cursor-pointer transition-all duration-500 flex flex-col justify-between backdrop-blur-sm"
        >
          ...
          <h2 className="text-5xl font-black text-white tracking-tighter italic uppercase">12.5k</h2>
        </div>

        {/* MEDIA COVERAGE */}
        <div 
          onClick={() => setExpandedCard('MEDIA')}
          className="bg-[#1e293b]/20 border border-orange-500/20 hover:border-orange-500/50 rounded-[2rem] p-8 cursor-pointer transition-all duration-500 flex flex-col justify-between backdrop-blur-sm"
        >

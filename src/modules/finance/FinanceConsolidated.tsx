    ...
    <div className="min-h-screen bg-[#F1F5F9] pb-20">
      ...
      <nav className="bg-white p-6 flex items-center justify-between shadow-sm mb-8">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 text-[10px] font-black uppercase text-slate-500 hover:bg-slate-50 transition-all">
            <Filter size={16} /> Filtrar
          </button>
          <button className="flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-500 text-white text-[10px] font-black uppercase shadow-lg shadow-emerald-200 hover:bg-emerald-600 transition-all">

...
const FinanceConsolidated: React.FC = () => {
  ...
  const masterContainers = [
    { id: 'cashflow', title: 'Fluxo de Caixa', icon: DollarSign, value: 'R$ 42.150,00', detail: 'Conciliação Ativa', path: '/financeiro/fluxo', color: 'border-emerald-500/30' },
    { id: 'receivables', title: 'Contas a Receber', icon: TrendingUp, value: 'R$ 12.800,00', detail: 'Gestão de Mensalidades', path: '/financeiro/receber', color: 'border-blue-500/30' },
    { id: 'payables', title: 'Contas a Pagar', icon: AlertCircle, value: 'R$ 4.320,00', detail: 'Autorização Tesouraria', path: '/financeiro/pagar', color: 'border-red-500/30' },
    { id: 'patrimony', title: 'Patrimônio & Bens', icon: Wallet, value: 'R$ 158.000,00', detail: 'Inventário de Ativos', path: '/financeiro/patrimonio', color: 'border-purple-500/30' }
  ];
      ...
      <aside className="w-64 bg-[#0a0f1e] border-r border-white/5 flex flex-col shrink-0">
        ...
        <div className="p-6 border-t border-white/5">
           <button onClick={() => navigate('/')} className="flex items-center gap-4 text-slate-500 hover:text-white transition-all group">
              <span className="text-[10px] font-black uppercase tracking-widest italic group-hover:text-emerald-500">← Nexus Portal</span>
           </button>
        </div>
      </aside>

      {/* ÁREA DE CONTEÚDO COM SCROLL ATIVADO */}
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        <header className="p-8 shrink-0 flex justify-between items-center bg-[#020617]/80 backdrop-blur-md z-10">
          <div>
          ...
          <div className="bg-white/5 px-4 py-1 rounded-full border border-white/10 text-[9px] font-black uppercase tracking-widest text-slate-400 italic">
            Live Sync: Online
          </div>
        </header>

        {/* CONTAINER DO GRID COM SCROLL INTERNO */}
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
                    <span className="text-[10px] font-black uppercase italic text-emerald-500">Acessar</span>
                ...
                <div className="mt-8">
                  ...
                  <h2 className="text-4xl font-black italic tracking-tighter text-white group-hover:text-emerald-500 transition-colors">
                    {container.value}
                  </h2>

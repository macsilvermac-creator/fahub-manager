...
export const SmartphoneIconAlt = (props: any) => <svg {...iconProps} {...props} viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>;
export const FileSignatureIconAlt = (props: any) => <svg {...iconProps} {...props} viewBox="0 0 24 24"><path d="M20 7h-9"></path><path d="M14 17H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2"></path><path d="M15 22v-4a2 2 0 0 1 2-2h4"></path></svg>;
